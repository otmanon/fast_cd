...
private:
    ...
    const int m_n;
    Eigen::CholmodDecomposition<Eigen::SparseMatrix<double>>* m_solver;

public:
    ///
    /// Constructor to create the matrix operation object.
    ///
    CholModSymShiftInvert(const SparseMatrix<double>& A, const SparseMatrix<double>& B, Eigen::CholmodDecomposition<Eigen::SparseMatrix<double>>* solver) :
    ...
    void set_solver(Eigen::CholmodDecomposition<Eigen::SparseMatrix<double>>* solver)
    {
        m_solver = solver;
    }
