...
class CholModSimplicialLDLTSymShiftInvert
{
public:
    using Scalar = double;
private:
    ...
    const int m_n;
    Eigen::CholmodSimplicialLDLT<Eigen::SparseMatrix<double>>* m_solver;

public:
    ///
    /// Constructor to create the matrix operation object.
    ///
    CholModSimplicialLDLTSymShiftInvert(const SparseMatrix<double>& A, const SparseMatrix<double>& B, Eigen::CholmodSimplicialLDLT<Eigen::SparseMatrix<double>>* solver) :
    ...
    void set_solver(Eigen::CholmodSimplicialLDLT<Eigen::SparseMatrix<double>>* solver)
    {
        m_solver = solver;
    }
